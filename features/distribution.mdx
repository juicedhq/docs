...
<CardGroup cols={2}>
  <Card title="Configuring distribution stages" icon="route" href="/guides/configuring-distribution-stages">
    Build a pipeline of stages that route leads from arrival to assignment.
  </Card>
  <Card title="Reading distribution logs" icon="activity" href="/guides/reading-distribution-logs">
