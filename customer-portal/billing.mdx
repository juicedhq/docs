...
Your current wallet balance is shown in the customer panel widgets that appear throughout the portal, so you can still see available funds without relying on a running-balance column in the transactions table.
