...
1. **Lead type** — Which lead type you want
...
| **Limited** | The bid's budget is running low—not enough to cover the full bid amount, but enough to participate at a reduced level. |
| **Under Funded** | The customer's wallet can cover the minimum bid but not the full bid amount. The bid competes at the reduced amount. |
| **Not Funded** | The customer's wallet can't cover even the minimum bid for this lead type. |
| **Capped** | A lead cap (daily, weekly, or monthly) has been reached. |
| **Exhausted** | A budget has been fully consumed. The bid won't receive leads until the period resets. |
| **Archived** | The bid has been deleted. |

### How statuses resolve to display
...
<Card title="Setting up bidding" icon="gavel" href="/guides/setting-up-bidding" horizontal>
  Turn on bidding, configure scope and pricing per lead type, and gate customer access.
</Card>
