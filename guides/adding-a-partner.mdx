...
- Tenant admin access with the **Manage Partners** permission.
...
- Change a user's role (Partner Admin ↔ Partner User) if your permissions allow.
...
To archive or delete a partner entirely, bulk-select it in the main Partners list and use the **Delete** bulk action. Deletion is soft — the record is hidden but historical leads remain associated for reporting. Only users with **Delete Any Partners** permission see the bulk action.
