...
- **Property Information** — Value, type, bedrooms, bathrooms, square footage, lot size, year built, sale history, assessed value, and annual tax
- **Owner Information** — Name, phone, email, owner-occupied status, age, and mailing address
...
Tenants can process leads to move them through the lifecycle. When processing, you choose where in the lifecycle to start:

| Option | What it does |
|--------|--------------|
| **Bidding** | Runs the lead through buyer matching and assignment |
| **Trigger Ping/Post** | Sends the lead through ping-post distribution |
| **Marketplace** | Makes the lead available for customers to claim |
| **Trigger Post Marketplace Direct Post** | Sends the lead directly to your configured direct post URL |

This is useful for leads that were held for audit, need to be re-routed, or should skip certain steps in the normal flow.
