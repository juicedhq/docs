...
Sometimes you want to see how a lead would be classified without committing to the changes. The **Reclassify** action lets you re-run the classification logic on a lead without saving it.

This is useful when:

- You want to preview how edits would affect the lead type before saving
- A lead type's conditions have changed and you want to check if existing leads should be reclassified
